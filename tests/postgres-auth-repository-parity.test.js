...
test("postgres auth repository supports login, refresh, invitations, and company context switching", async () => {
  ...
  assert.equal(ownerOneVerified.company.name, "�ٹ� Ŭ�� 1ȣ��");
  ...
  assert.equal(ownerOneSession.companyName, "�ٹ� Ŭ�� 1ȣ��");
  ...
  assert.equal(refreshed.company.name, "�ٹ� Ŭ�� 1ȣ��");
  ...
  assert.equal(invite.companyName, "�ٹ� Ŭ�� 2ȣ��");
